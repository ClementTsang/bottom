...
pub use config::{OpenTelemetryConfig, MetricsConfig};
pub use exporter::{OpenTelemetryExporter, OpenTelemetryMetrics, SystemMetrics};
pub use integration::{OpenTelemetryIntegration, OpenTelemetryStats, OpenTelemetryError};
...
mod tests {
    ...
    async fn test_check_availability_invalid_config() {
        ...
        assert!(matches!(result.unwrap_err(), OpenTelemetryError::ConfigError(_)));
    }
