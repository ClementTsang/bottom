...
impl DataCollector {
    pub fn new(filters: DataFilters) -> Self {
        DataCollector {
            ...
            change_memory_prefix: String::from("auto"),
    ...
    pub fn set_change_memory_prefix(&mut self, change_memory_prefix: String) {
        self.change_memory_prefix = change_memory_prefix;
    }
