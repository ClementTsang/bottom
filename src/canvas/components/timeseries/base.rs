...
use crate::canvas::{components::timeseries::*, drawing_utils::widget_block};
...
mod test {
    ...
    use crate::canvas::components::timeseries::Axis;
    ...
    fn create_timeseries() -> TimeGraph<'static> {
        TimeGraph {
            title: " Network ".into(),
            x_min: -15000.0,
            hide_x_labels: false,
    ...
    #[test]
    fn timeseries_gen_x_axis() {
        let tg = create_timeseries();
